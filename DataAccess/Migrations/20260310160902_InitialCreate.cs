        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ReasonForVisit = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ClinicAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorEarnings", x => x.EarningId);
                    table.ForeignKey(
                        name: "FK_DoctorEarnings_Appointments_AppointmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LabTests = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorEarnings_AppointmentId",
